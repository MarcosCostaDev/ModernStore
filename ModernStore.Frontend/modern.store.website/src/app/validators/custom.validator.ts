...
export class CustomValidator {
    ...
    public static NegativeNumberValidator(control: FormControl) {
    ...
    public static ZipCodeValidator(control: FormControl) {
    ...
    public static SelectValidator(control: FormControl) {
